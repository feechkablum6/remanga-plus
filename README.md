...
- **Сайт** — что скрывать на самом сайте (кнопки шапки, баннер игры на главной).
...
3. Если «**Parser-server :7845**» с бирюзовым кружком — сервер работает, и иконки-перезагрузки не будет видно (это норма).
