...
## 📥 Установка на macOS (3 шага, ~2 минуты)

> Для M1/M2/M3/M4 (Apple Silicon). Premium Free работает только на macOS; на Windows работает чистка интерфейса (см. ниже).
...
3. Если по-прежнему не работает — переустанови `Remanga-Plus.pkg` (двойной клик ещё раз).
...
Чистка интерфейса и чтение расширения работают везде. Premium Free (открывание платных глав) пока только macOS.
